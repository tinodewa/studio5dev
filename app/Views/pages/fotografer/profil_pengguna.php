<?= $this->extend('pages/fotografer/template/page_layout_profile.php') ?>
        ...
        <div class="bg-image bg-image-bottom" style="background-image: url('/assets/admin/media/photos/photo13@2x.jpg');">
            <div class="bg-primary-dark-op py-30">
                <div class="content content-full text-center">
                    ...
                    <!-- Actions -->
                    <a class="btn btn-rounded btn-hero btn-sm btn-alt-secondary mb-5 px-20" href="/fotografer/profil/edit">
