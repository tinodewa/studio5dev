                        ...
                        <div class="block-content">
                            <form action="/admin/paket/new" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-9">
                                        <div class="form-material floating">
                                            <input type="text" id="input-nama-paket" name="nama_paket" class="form-control" value="" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-jumlah-fotografer" name="jumlah_fotografer" class="form-control" value="" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-jumlah-videografer" name="jumlah_videografer" class="form-control" value="" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-waktu-liputan" name="waktu_liputan" class="form-control" value="" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-jumlah-indoor" name="jumlah_indoor" class="form-control" value="" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-jumlah-outdoor" name="jumlah_outdoor" class="form-control" value="" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-hasil-jumlah" name="hasil_jumlah" class="form-control" value="" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-hasil-editing" name="hasil_editing" class="form-control" value="" required>
