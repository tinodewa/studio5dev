                ...
                <div class="col-md-12">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Update Ulasan</h3>
                        </div>
                        <div class="block-content">
                            <form action="/admin/ulasan/<?= $ulasan->id_ulasan ?>/edit" method="post">
                                <div class="form-group row">
                                    <div class="col-md-9">
                                        <div class="form-material floating">
                                            <input type="text" id="input-id" name="id" class="form-control d-none" value="<?= $ulasan->id_ulasan ?>">
                                            <input type="text" id="input-id" name="id_show" class="form-control" value="<?= $ulasan->id_ulasan ?>" disabled>
                                        ...
                                        <div class="form-material">
                                            <select class="form-control" id="input-id-user" name="id_user">
                                                <?php foreach ($users as $key => $user) : ?>
                                                    <option value="<?= $user->id_user ?>" <?php if ($ulasan->id_user == $user->id_user) {
                                                                                                echo 'selected';
                                                                                            } ?>>
                                                        <?= $user->id_user ?>
                                                    </option>
                                        ...
                                        <div class="form-material">
                                            <select class="form-control" id="input-id-paket" name="id_paket">
                                                <?php foreach ($pakets as $key => $paket) : ?>
                                                    <option value="<?= $paket->id_paket ?>" <?php if ($paket->id_paket == $ulasan->id_paket) {
                                                                                                echo 'selected';
                                                                                            } ?>>
                                                        <?= $paket->id_paket ?>
                                                    </option>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material">
                                            <input type="date" id="input-tanggal" name="tanggal" class="form-control" value="<?= $ulasan->tanggal ?>" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-9">
                                        <div class="form-material floating">
                                            <textarea class="form-control" id="input-deskripsi" name="deskripsi" rows="4" required><?= $ulasan->deskripsi ?></textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-9">
                                        <div class="form-material floating">
                                            <input type="number" id="input-bintang" name="bintang" class="form-control" value="<?= $ulasan->bintang ?>" required>
