...
class PesananWithUserAndPaket extends Model
{
    ...
    protected $allowedFields    = ['id_pesanan, id_paket, nama_lengkap, tanggal_mulai, tanggal_selesai, telp, alamat, catatan, extra_waktu_kerja, email, no_telp, nama_paket, harga_paket, fotografer, videografer, asisten, waktu_kerja, jumlah_foto, jumlah_foto_edit, cetak_foto, videografi, penyimpanan, note, deskripsi_paket, extra_premium_magazine, extra_background, extra_tempat, extra_orang, extra_wisudawan, created_at, updated_at'];

    public function getPesananWithUserAndPaket()
    {
        $db = db_connect();
        $builder = $db->table('pesanan');
        $builder->select('pesanan.id_pesanan, paket.id_paket, pesanan.nama_lengkap, pesanan.tanggal_mulai, pesanan.tanggal_selesai, pesanan.telp, pesanan.alamat, pesanan.catatan, pesanan.extra_waktu_kerja, pesanan.extra_premium_magazine, pesanan.extra_background, pesanan.extra_tempat, pesanan.extra_orang, pesanan.extra_wisudawan, user.email, user.no_telp, paket.nama_paket, paket.harga_paket, paket.fotografer, paket.videografer, paket.asisten, paket.waktu_kerja, paket.jumlah_foto, paket.jumlah_foto_edit, paket.cetak_foto, paket.videografi, paket.penyimpanan, paket.note, paket.deskripsi_paket, pesanan.created_at, pesanan.updated_at');
